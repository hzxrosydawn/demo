...
layui.define(["layer", "config", "layRouter"], function (g) {
        ...
        flexible: function (p) {
            ...
            if (p && p != "") {
                ...
                if (t && t.length > 0) {
                    ...
                    if (q > 0) {
                        i(f).animate({"scrollTop": i(f).scrollTop() + q}, 100)
                    } else {
                        if (s > 0) {
                            i(f).animate({"scrollTop": i(f).scrollTop() - s}, 100)
                        }
                    }
                } else {
                }
            ...
            q.error = function (r) {
                q.success({code: r.status, msg: r.statusText})
            };
            ...
            if (u) {
                layui.data(c.tableName, {key: "theme", value: u});
                if (d == u) {
                    u = undefined
                }
            } else {
    ...
    n.events = {
        flexible: function (q) {
            ...
            var x = "layui-icon-screen-full", r = "layui-icon-screen-restore";
            var p = i(this).find("i");
    ...
    i(document).on("mouseenter", "*[lay-tips]", function () {
        ...
        k.tips(p, this, {tips: [q || 3, r || "#333333"], time: -1})
    ...
    i(document).on("mouseenter", m + "," + m + " .layui-nav-child>dd", function () {
        if (n.getPageWidth() > 750) {
            ...
            if (s.length > 0) {
                ...
                if (q.hasClass("layui-nav-item")) {
                    ...
                    k.tips(p, q, {
                        tips: [2, "#333333"], time: -1, success: function (t, u) {
        ...
        k.closeAll("tips");
        i(this).removeClass("admin-nav-hover");
        i(this).find(">.layui-nav-child").removeClass("show-top")
    });
    ...
    n.chooseLocation = function (u) {
        ...
        r += "   </div>";
        n.open({
            id: "ew-map-select", type: 1, title: q, area: "750px", content: r, success: function (E, F) {
    ...
    n.cropImg = function (s) {
        ...
        layui.use(["cropper", "upload"], function () {
            ...
            function A() {
                ...
                var C = {aspectRatio: x, preview: "#ew-crop-img-preview"};
                D.cropper(C);
                i(".ew-crop-tool").on("click", "[data-method]", function () {
                    var G = D.data("cropper");
                    var H = i(this).data(), I, F;
                    if (!G || !H.method) {
                        return
                    }
                    H = i.extend({}, H);
            ...
            B += "   </div>";
            n.open({
                title: p, area: "665px", type: 1, content: B, success: function (C, D) {
